class PrescriptionsController < ApplicationController
  ...
  def new
    ...
    @drugs = ['Selecione', nil] #Drug.all.map { |drug| [drug.name, drug.id] }
  end
  ...
  def create
    ...
    @prescription.patient = Patient.new(prescription_params[:patient])
    @prescription.drug = Drug.new(prescription_params[:drug])
